...
export class EditProfileDetailsDialogComponent implements OnInit {
        ...
        if (res) {
          ...
          if (this.currentLoginUserDetails.user_info) {
            this.editProfile = this.fb.group({
              workplace: this.currentLoginUserDetails.user_info.workplace
                ? this.currentLoginUserDetails.user_info.workplace
                : '',
              highSchool: this.currentLoginUserDetails.user_info.highSchool
                ? this.currentLoginUserDetails.user_info.highSchool
                : '',
              university: this.currentLoginUserDetails.user_info.university
                ? this.currentLoginUserDetails.user_info.university
                : '',
              coverPhoto: '',
              currentCity: this.currentLoginUserDetails.user_info.currentCity
                ? this.currentLoginUserDetails.user_info.currentCity
                : '',
              homeTown: this.currentLoginUserDetails.user_info.homeTown
                ? this.currentLoginUserDetails.user_info.homeTown
                : '',
              relation: this.currentLoginUserDetails.user_info.relation
                ? this.currentLoginUserDetails.user_info.relation
                : '',
  ...
  onEditProfile() {
    ...
    this.userService.createUserInfo(formData).subscribe(
      (res: any) => {
